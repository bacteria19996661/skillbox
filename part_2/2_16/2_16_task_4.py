...
#
# ----------- СЛЕДУЮЩИЙ ЭТАП --------------------
# def decorator_with_args_for any_decorator(decorator_to_enhance: Callable):
#     """ Декоратор. Дает возможность другому декоратору принимать произвольныеаргументы. Пишем далее как в уроке про декораторы с аргументами. """
#     def decorator_maker(*args, **kwargs) -> Callable:
#         # Далее создаем декоратор, который принимает только функцию, но сохраняет все аргументы, переданные своему создателю)
...
#
# def decorated_decorator(func: Callabe, *dec_args, **dec_kwargs) -> Callabe:
#    " Декоратор шаблон "
#     @functools.wraps(func)
